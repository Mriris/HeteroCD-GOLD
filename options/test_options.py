...
class TestOptions:
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--name', type=str, default='GOLD_test2', help='实验名称，用于创建结果子目录')
        parser.add_argument('--gpu_ids', type=str, default='2', help='使用的gpu ids，例如 0 或 0,1,2。使用-1表示CPU')
        ...
        parser.add_argument('--phase', type=str, default='test', help='test, val等')
        ...
        parser.add_argument('--kl_div_reduction', type=str, default='mean', 
                            help='KL散度损失的缩减方式 [mean | batchmean | sum | none]')
