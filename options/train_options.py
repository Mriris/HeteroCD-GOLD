...
class TrainOptions():
    ...
    def initialize(self, parser):
        # basic parameters
        parser.add_argument('--dataroot', default='/data/jingwei/yantingxuan/Datasets/CityCN/Test', help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
